            ...
            <div class="row">
              <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0">Detail Informasi</h4>
                    ...
                    <div id="accordion" class="custom-accordion">
                      <div class="card mb-1 shadow-none">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
                          <div class="card-body">
                            <div class="row mb-3">
                                <label for="nama-admin" class="col-sm-2 col-form-label">Nama Admin</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="nama-admin">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                <label for="foto-admin" class="col-sm-2 col-form-label">Foto Admin</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="file"  id="foto-admin">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                <label for="link-admin" class="col-sm-2 col-form-label">Link Profil</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text"  id="link-admin">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="mb-3 row mt-4">
                                <div class="col">
                                  <a href="profil-kelola.php" type="button" class="btn btn-success"><i class="ri-pencil-fill"></i> Ubah</a>
                                </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="card mb-1 shadow-none">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordion">
                          <div class="card-body">
                            ...
                            <div class="mb-3 row mt-4">
                                <div class="col">
                                  <a href="email-kelola.php" type="button" class="btn btn-success"><i class="ri-pencil-fill"></i> Ubah</a>
                                </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="card mb-1 shadow-none">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordion">
                          <div class="card-body">
                            <div class="row mb-3">
                                <label for="password-admin" class="col-sm-2 col-form-label">Password</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="password"  id="password-admin">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="mb-3 row mt-4">
                                <div class="col">
                                  <a href="password-kelola.php" type="button" class="btn btn-success"><i class="ri-pencil-fill"></i> Reset</a>
                                </div>
                            </div>
                          </div>
                        </div>
