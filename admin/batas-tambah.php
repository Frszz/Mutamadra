                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Tambah Batas Waktu Mutasi</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        <label for="tgl-batas" class="col-sm-2 col-form-label">Tanggal Batas</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="date" id="tgl-batas">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
