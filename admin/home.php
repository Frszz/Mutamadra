          ...
          <div class="d-flex">
            ...
            <div class="navbar-brand-box">
              <a href="home.php" class="logo logo-dark">
                ...
                <span class="logo-lg"
                  ><h2 style="margin-top: 1rem"><img src="assets/images/logo.png" alt="logo-sm-dark" height="22" /> Sekolah</h2>
                </span>
              </a>
              ...
              <a href="home.php" class="logo logo-light">
                ...
                <span class="logo-lg"
                  ><h2 style="margin-top: 1rem; color: white"><img src="assets/images/logo.png" alt="logo-sm-light" height="22" /> Sekolah</h2>
                </span>
              </a>
            </div>
            ...
            <form class="app-search d-none d-lg-block">
              <div class="input-group">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="pendaftaran.php">Pendaftaran</a></li>
                </ul>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  ...
                  <li><a href="#">Laporan Mutasi Siswa</a></li>
                </ul>
              </li>
              <!-- end li -->
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  <li><a href="#">Batas Waktu Mutasi</a></li>
                </ul>
              </li>
              <!-- end li -->
            </ul>
                  ...
                  <div class="card-body">
                    <div class="dropdown float-end">
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item">Sekolah</a>
                      </div>
                    </div>
                    <!-- end dropdown -->
