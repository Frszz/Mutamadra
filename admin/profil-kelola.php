                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Ubah Data Profil</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        <label for="link-admin" class="col-sm-2 col-form-label">Link Profle</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="mb-3 row mt-5">
                                      <div class="col">
                                        ...
                                        <a href="bantuan.html" type="button" class="btn btn-danger"><i class="ri-reply-fill"></i> Kembali</a>
                                      </div>
                                    </div>
                                </div>
                                <!-- end cardbody -->
